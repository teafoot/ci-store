...
<div class="row-fluid sortable">
  <div class="box span12">
    <div class="box-header" data-original-title>
      <h2><i class="halflings-icon white edit"></i><span class="break"></span>Assign Category</h2>
      <div class="box-icon">
    ...
    <div class="box-content">
      <p>Assign to a new category and hit submit.</p>
      <?php
      ...
      <form class="form-horizontal" method="post" action="<?php echo $form_location; ?>">
        <fieldset>
          <div class="control-group">
            ...
            <div class="controls">
              <?php
              echo form_dropdown('cat_id', $options, $cat_id);
              ?>
            </div>
          </div>
